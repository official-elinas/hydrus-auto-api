...
1. Get `model-resnet_custom_v3.h5` and place it in `deepdanbooru/project/model-resnet_custom_v3.h5` - you can get this from the `models` folder in auto's UI or download it online
